...
const projects = [
  {
    ...
    description: 'Led migration from legacy design system to modern architecture using Micro-Frontend patterns with Next.js and Webpack Module Federation. Built 10+ accessible, high-performance components.',
  ...
  },
  {
    ...
    description: 'Led platform-wide rebranding effort, updating design tokens, UI assets, and integrating Headless CMS. Built accessible design system components in partnership with design teams.',
    image: '/placeholder.svg?height=300&width=500',
  ...
  },
  {
    ...
    company: 'AlertD',
    description: 'Developed full-stack features for real-time metrics dashboards with advanced prompt engineering for AI-powered user experiences. Built POCs for chat history visualization.',
    image: '/placeholder.svg?height=300&width=500',
  ...
  },
  {
    ...
    description: 'Migrated multiple e-commerce sites to Next.js and Nuxt.js for modern performance. Built CI/CD pipelines and containerized development environments.',
    image: '/placeholder.svg?height=300&width=500',
  ...
  },
  {
    ...
    description: 'Designed and developed a full web application from scratch using Vue.js and Node.js. Created REST APIs and CI/CD pipelines for automated deployment.',
    image: '/placeholder.svg?height=300&width=500',
  ...
  },
  {
    ...
    description: 'Developed CRM modules from scratch to enhance accountability and tracking. Integrated third-party APIs and optimized complex SQL queries.',
    image: '/placeholder.svg?height=300&width=500',
      ...
      <div className="container px-4 md:px-6 relative z-10">
        ...
        <div className="grid gap-8 lg:grid-cols-1 mb-16">
          {featuredProjects.map((project, index) => (
            <Card key={index} className="morphism-card border-white/10 overflow-hidden group glow-hover">
              <div className="grid lg:grid-cols-2 gap-0">
                ...
                <div className="p-8 flex flex-col justify-between">
                  <div>
                    ...
                    <div className="mb-6">
                      <h4 className="text-sm font-semibold mb-3 text-muted-foreground uppercase tracking-wide">Key Achievements</h4>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {project.technologies.map((tech, techIndex) => (
                          <Badge key={techIndex} variant="outline" className="morphism-card border-white/20 text-xs">
                            {tech}
                          </Badge>
                        ))}
                      </div>
                  ...
                  <div className="flex gap-3">
                    <Button size="sm" className="btn-elegant text-white flex-1" asChild>
                      <Link href={project.demo} target="_blank">
                        <ExternalLink className="mr-2 h-4 w-4" />
                        Case Study
                      </Link>
                    </Button>
                    <Button size="sm" variant="outline" className="morphism-card border-white/20 hover:bg-white/10" asChild>
            ...
            {otherProjects.map((project, index) => (
              <Card key={index} className="morphism-card border-white/10 overflow-hidden group glow-hover">
                <div className="aspect-video relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-black/20 to-black/40"></div>
                  <div className="absolute bottom-4 right-4">
                    <div className="w-10 h-10 rounded-full morphism-card flex items-center justify-center">
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div>
                      <h4 className="text-xs font-semibold mb-2 text-muted-foreground uppercase tracking-wide">Achievements</h4>
                ...
                <CardFooter className="flex gap-2">
                  <Button size="sm" className="btn-elegant text-white text-xs" asChild>
                    <Link href={project.demo} target="_blank">
                      <ExternalLink className="mr-1 h-3 w-3" />
                      View
                    </Link>
                  </Button>
                  <Button size="sm" variant="outline" className="morphism-card border-white/20 hover:bg-white/10 text-xs" asChild>
                    <Link href={project.github} target="_blank">
