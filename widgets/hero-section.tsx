      ...
      <div className="container px-4 md:px-6 relative z-10">
        <div className="flex flex-col items-center space-y-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button size="lg" className="glow-hover bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 border-0" asChild>
              <Link href="#contact">
                <Mail className="mr-2 h-4 w-4" />
                Get In Touch
              </Link>
            </Button>
            <Button size="lg" variant="outline" className="morphism-card border-white/20 hover:bg-white/10" asChild>
