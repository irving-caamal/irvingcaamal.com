...
const experiences = [
  {
    ...
    type: 'FTE / Contractor',
    description: 'Applied advanced prompt engineering techniques to improve AI-powered user experiences. Contributed to modular architecture for early-stage product development.',
    achievements: [
  ...
  },
  {
    ...
    type: 'FTE / Contractor',
    description: 'End Client: MGM Resorts International. Led migration from legacy design system to modern architecture using Micro-Frontend patterns.',
    achievements: [
  ...
  },
  {
    ...
    type: 'FTE / Contractor',
    description: 'End Client: Teachers Pay Teachers. Led platform-wide rebranding effort, updating design tokens, UI assets, and integrating Headless CMS.',
    achievements: [
  ...
  },
  {
    ...
    type: 'Presential / FTE',
    description: 'Designed and developed a full web application from scratch using Vue.js and Node.js. Created REST APIs and CI/CD pipelines.',
    achievements: [
  ...
  },
  {
    ...
    description: 'Migrated multiple e-commerce sites to Next.js and Nuxt.js for modern performance. Built CI/CD pipelines and containerized dev environments.',
    achievements: [
  ...
  const education = [
    {
      ...
      description: 'Comprehensive program covering software engineering principles, system design, and modern development practices.'
    }
  ]
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-6">
              {experiences.map((exp, index) => (
                <Card key={index} className="morphism-card border-white/10 glow-hover">
                  <CardHeader>
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2">
                      ...
                      <div className="flex flex-col sm:items-end gap-1">
                        <Badge variant="outline" className="morphism-card border-white/20 text-xs">
                          {exp.period}
                        </Badge>
                  ...
                  <CardContent>
                    ...
                    <div className="space-y-4">
                      <div>
                        <h4 className="font-semibold text-sm mb-3 text-muted-foreground uppercase tracking-wide">Key Achievements</h4>
                      ...
                      <div>
                        <h4 className="font-semibold text-sm mb-3 text-muted-foreground uppercase tracking-wide">Technologies</h4>
                        <div className="flex flex-wrap gap-2">
                          {exp.technologies.map((tech, techIndex) => (
                            <Badge key={techIndex} variant="secondary" className="morphism-card border-white/10 text-xs">
                              {tech}
                            </Badge>
                          ))}
                        </div>
                  ...
                  <Card key={index} className="morphism-card border-white/10 glow-hover">
                    <CardHeader>
                      <div className="flex items-start gap-3">
                        <div className="w-12 h-12 rounded-xl morphism-card flex items-center justify-center">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-4 mt-2">
                            ...
                            <Badge variant="secondary" className="morphism-card border-white/10 text-xs">
                              {cert.type}
                            </Badge>
                          </div>
                        </div>
